 ...
 *
 * It also includes MarkerWithLabel.
 * 
 * @return {object} Google maps object.
 */
define(['async!http://maps.google.com/maps/api/js?key=AIzaSyDoSHk4M0GEYS0n0ZDuxlINchpg_N6EuZI&v=3&sensor=false'], function() {
	/**
	 ...
	 */
	google.maps.MarkerWithLabel = function MarkerWithLabel(opt_options) {
	...
	google.maps.MarkerWithLabel.prototype = new google.maps.Marker();
	 ...
	 * @private
	 */
	google.maps.MarkerWithLabel.prototype.setMap = function (theMap) {
